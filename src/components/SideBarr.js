        ...
        <nav id="sidebar" >
            <div style={{height:"10%"}}>
                <div className='SideBar_items' style={{display:"flex", justifyContent:"start"}}>
                    <img src="https://th.bing.com/th/id/OIP.a6pCQ03y9qfhpe2lAjAnBwAAAA?rs=1&pid=ImgDetMain" alt="not" className="logo"></img>
                </div>
            </div>
            <div style={{height:"90%"}}>
             ...
             <div  className="user">
            <div className='user_items'>Suraj Pokhriyal</div>
